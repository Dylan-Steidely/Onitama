...
class Game:  # NOQA E302
    def __init__(self):
        ...
        # this is the initial card selector variable determines where the card selector will start from
    ...
    def key_down(self, event):  # NOQA E301
        ...
        # UP and Down is for the card selector
            ...
            for cards in selected_cards_list:
                # List of selected_cards for the game is in the selected cards list and this cycles through and
                # checks their position and see where they belong
    ...
    def update_card_image(self):  # NOQA
        # this makes the 
    ...
    def selected_tile_mover(self, direction_x, direction_y):
        # This method is the movement for the tile selector it takes inputs from the event checker to get the
        # x and y direction of movement
        # the following series of statements will check to make sure the selector remains on the board by checking
        ...
        if self.selected_tile_coord_x + direction_x >= 6:
            ...
            # if it passes the checks above this series of if statements. Admittedly this is pretty ugly code, but
            # it gets the job done.
            # it checks the x,y tuple to see which tile it is...for every tile on the board...yeah all 25.
            # kinda stupid.
            ...
            # Now that the original tile is no longer selected it is time to change the tuple and do the same for
    ...
    def update_game(self):
        ...
        self.draw_cards()  # function that continuously draws the cards
        # more cancerous programming that could be solved with a for loop and a list
        # Again if this is still here as a comment it is because I bit off more than I could chew and couldn't
        # fix everything
